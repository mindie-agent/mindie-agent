...
Windows desktop acceptance or reliable Grok PR event delivery. Windows work proceeds after merge on the user's dedicated machine. Merge is distinct from release acceptance. Old business Skills and profiling remain deferred.
